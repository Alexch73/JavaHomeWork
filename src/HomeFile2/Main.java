...
public static void main(String[] args) throws IOException {
        ...
        File file = new File(loader.getResource("\"D:/java/ls/src/HomeFile2/wp.txt\"").getFile());
        File file2 = new File(loader.getResource("\"D:/java/ls/src/HomeFile2/articles.txt\"").getFile());
